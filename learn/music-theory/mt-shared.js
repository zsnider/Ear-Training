...
const MT_COURSES = [
  ...
  { num:5, id:'keys',         label:'Keys & Circle of Fifths', url:'/learn/music-theory/keys/',       accent:'#c084fc',
    lessons:['Key Signatures','The Circle of Fifths','Relative Major & Minor','Parallel Keys'] },
  { num:6, id:'progressions', label:'Chord Progressions',    url:'/learn/music-theory/progressions/', accent:'#fb7185',
    lessons:['Roman Numeral Analysis','Diatonic Chords','Common Progressions','Functional Harmony','Modal Interchange'] },
  { num:7, id:'rhythm',       label:'Rhythm & Meter',        url:'/learn/music-theory/rhythm/',       accent:'#a3e635',
    lessons:['Note Values','Time Signatures','Ties & Dots','Syncopation','Feel & Groove'] },
  { num:8, id:'notation',     label:'Staff Notation',        url:'/learn/music-theory/notation/',     accent:'#e879f9',
